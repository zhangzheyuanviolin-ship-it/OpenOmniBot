...
class ChannelManager {
    ...
    private var dataSyncChannel: DataSyncChannel = DataSyncChannel()
    ...
    fun configureFlutterEngine(flutterEngine: FlutterEngine
        ...
        dataSyncChannel.setChannel(flutterEngine)
    }
    ...
    fun onCreate(context: Context) {
        ...
        dataSyncChannel.onCreate(context)
    }
